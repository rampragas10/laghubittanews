...
//               <span className="rounded-full bg-[#005b37] px-3 py-1 text-xs font-bold text-white">मुख्य समाचार</span>
//               {lead.breaking && <span className="rounded bg-red-100 px-3 py-1 text-xs font-bold text-red-700">BREAKING</span>}
//             </div>
//             <h1 className="text-2xl font-bold leading-tight text-[#005b37] md:text-4xl">{lead.title}</h1>
//             <div className="mt-5 aspect-[21/9] overflow-hidden rounded-lg bg-gray-100">
//               {lead.coverImage && <img src={lead.coverImage} alt={lead.imageAlt || lead.title} className="h-full w-full object-cover" />}
//             </div>
//             <div className="mt-5 flex flex-col gap-4 md:flex-row">
//               <p className="flex-1 text-base leading-8 text-gray-700">{lead.excerpt}</p>
//               <a href={`/news/${lead.slug}`} className="self-start rounded-lg bg-[#005b37] px-4 py-2 font-bold text-white">विस्तृत पढ्नुहोस्</a>
//             </div>
//           </article>
//         )}
...
//             {data.latest.slice(1, 3).map((n) => <NewsCard key={n._id} news={n} />)}
//           </section>
//         )}

//         <Section title="लघुवित्त समाचार" href="/category/microfinance-news" news={data.latest.slice(0, 6)} />

//         <section className="flex flex-col gap-4">
//           <div className="flex items-center justify-between rounded bg-[#006d36] px-4 py-3 text-white">
//             <h2 className="text-xl font-bold">लघुवित्त विशेष</h2>
//             <a href="/category/microfinance-special" className="text-sm text-[#8cf9a9]">थप विशेष →</a>
//           </div>
//           <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
//             {data.special.map((n) => <NewsCard key={n._id} news={n} />)}
//           </div>
//         </section>

//         <section className="grid grid-cols-1 gap-6 rounded-xl bg-[#eff4ff] p-4 md:p-6 lg:grid-cols-3">
//           <Section title="विचार" news={data.opinion} href="/category/opinion-and-editorial" />
//           <Section title="उद्यमशीलता" news={data.entrepreneurship} href="/category/entrepreneurship" />
//           <Section title="फोटो कथा" news={data.photo} href="/category/photo-stories" />
//         </section>

//         <Section title="लघुवित्त सूचना" href="/category/notices-and-vacancy" news={data.notices} />
//         <Section title="राष्ट्रिय नीति" href="/category/national-policy" news={data.policy} />

//         <aside className="rounded-xl bg-[#27313f] p-6 text-white">
//           <h3 className="font-bold text-[#8cf9a9]">संपादकीय प्रतिबद्धता तथा सर्वाधिकार जानकारी</h3>
//           <p className="mt-2 text-sm leading-7 opacity-90">
//             वित्तीय साक्षरता र उद्यमशीलताका लागि प्रकाशित Laghubitta News वित्तीय क्षेत्रको डिजिटल प्लेटफर्म हो। यहाँ वित्तीय क्षेत्र, लघुवित्त तथा उद्यमशीलतासम्बन्धी अध्ययन सामग्री र समाचार प्रकाशित गरिन्छ।
//           </p>
//           <div className="mt-3 text-xs opacity-80">media.intnepal@gmail.com · ९७४१८०३६००</div>
//         </aside>
//       </main>
//       <Footer />
//     </>
